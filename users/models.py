...
class Payment(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, blank=True, null=True, related_name="payments"
    )
    ...
    link_payment = models.URLField(
        max_length=450, blank=True, null=True, verbose_name="Ссылка на оплату"
    )
    status = models.CharField(
        max_length=10, default="Создан", verbose_name="Статус платежа"
    )
